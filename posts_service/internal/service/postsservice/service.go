...
func (s *PService) CreatePost(_ context.Context, pb *pb.PostDataRequest, userID int32) error {
	post := models.DbPost{
		Name:         pb.PostName,
		Tags:         pb.Tags,
...
func (s *PService) DeletePost(_ context.Context, pb *pb.PostID, userID int32) error {
...
func (s *PService) UpdatePost(_ context.Context, pb *pb.UpdatePostRequest, userID int32) error {
	post := models.DbPost{
		UpdatedAt:    time.Now(),
		Id:           int(pb.PostId),
...
func (s *PService) GetPost(_ context.Context, p *pb.PostID, userID int32) (*pb.PostDataResponse, error) {
...
func (s *PService) GetPostList(_ context.Context, p *pb.PaginatedListRequest, userID int32) (*pb.ListPostsResponse, error) {
...
func (s *PService) PostComment(ctx context.Context, pb *pb.PostCommentRequest, userID int32) error {
...
func (s *PService) PostLike(ctx context.Context, pb *pb.PostID, userID int32) error {
	like := models.DbLike{
		PostId: int(pb.PostId),
		UserId: int(userID),
	}
...
func (s *PService) PostView(ctx context.Context, pb *pb.PostID, userID int32) error {
	view := models.DbView{
		PostId: int(pb.PostId),
		UserId: int(userID),
	}
...
func (s *PService) GetCommentList(_ context.Context, p *pb.PaginatedListRequest, userID int32) (*pb.ListCommentsResponse, error) {
